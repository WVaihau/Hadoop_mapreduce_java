...
public class Species_counter {
    // MapReduce job that displays the list of different species trees in trees.csv
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "species counter"); // Job name
        job.setJarByClass(Species_counter.class);

        // Set Mapper to species_mapper
        job.setMapperClass(species_mapper.class);
